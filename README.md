...
2. Выполняем запрос POST /urlshortcut/authorization с телом JSON, {"login" : "выданный логин", "password": "выданный пароль"} 
...
3. Далее выполняем запрос POST /urlshortcut/convert с телом JSON содержащим в хедерах токен доступа и производный url
   Пример JSON { "url" : "https://stackoverflow.com/questions/70121462/use-a-secondary-h2-database-for-testing-an-api-in-spring-boot" }
